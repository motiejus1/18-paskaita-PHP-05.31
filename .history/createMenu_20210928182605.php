...
<body>
    ...
    <?php require_once("design-parts/meniu.php"); ?>
        ...
        <form action="createMenu.php" method="get">
            <input type="radio" name="menuType" value="1"> Pasirinktinė nuoroda <br>
            <input type="radio" name="menuType" value="2"> Nuoroda į kategoriją
            <input type="radio" name="menuType" value="3"> Nuoroda į puslapį
        </form>
