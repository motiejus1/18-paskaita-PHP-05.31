...
<div class="container">
        ...
        <form action="admin.php">
            ...
            ?>
            <input type="radio" name="sidebar" value="0" <?php echo $cheked; ?>/> Sidebar neatvaizduojamas </br>
            <input type="radio" name="sidebar" value="1" <?php echo $cheked; ?>/> Sidebar kaireje </br>
