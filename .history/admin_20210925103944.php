...
<div class="container">
        ...
        <form action="admin.php">
            <input type="radio" value="0"/>Sidebar neatvaizduojamas </br>
            <input type="radio" value="1"/>Sidebar kaireje </br>
            <input type="radio" value="2"/>Sidebar desineje </br>
            <input type="submit" name="submit">Išsaugoti
        </form>
