            ...
            if(isset($_GET["menuType"])) {
                ...
                <?php } else if($menuType == 2) { ?>
                    ...
                    <form action="createMenu.php" method="get">
                        ...
                        //mes pagal selecta turetume pasiimti kategorijos ID
                        //pagal kategorijos ID kreiptis i duomenu baze su SELECT ir gauti pavadinima kategorijos
                        //irasas yra vienas vienintelis, gauname jo pavadinima
                        //sita gauta informacija + target ir alt yra irasoma i meniu lentele

                        if(isset($_GET["create"])) {
                            $category_id = $_GET["categories"]; // 1 2, 42 ir t.t.
                            $sql = "SELECT * FROM kategorijos WHERE ID = $category_id";//viena vieniteli irasa
