            ...
            if(isset($_GET["menuType"])) {
                ...
                <?php if($menuType == 1) { ?>
                    ...
                    <form action="createMenu.php" method="get">
                        ...
                        <input class="form-control" type="radio" name="target" value="_"> Atsidarys tame pačiame locale_get_display_name
                        <input class="form-control" type="radio" name="target"> Atsidarys kitame lange
