    ...
    <div class="col-lg-9">
        ...
        <?php 
            ...
            if(isset($_GET["catID"]) && !empty($_GET["catID"])) { //egzistuoja
                ...
                $sql = "SELECT puslapiai.pavadinimas, puslapiai.nuoroda, puslapiai.santrauka, kategorijos.pavadinimas AS kategorijos_pavadinimas 
                FROM puslapiai 
            ...
            <div class="card col-lg-4" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="catd-text"><a  href="index.php?catID=" ><?php echo $pages["kategorijos_pavadinimas"]; ?></a>  </p>
