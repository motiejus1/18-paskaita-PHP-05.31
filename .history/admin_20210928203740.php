...
<div class="container">
        ...
        <form action="admin.php" method="get">
            <input  type="radio" name="target" value="nerodyti" checked="true"> Nerodyti kategorijų dropdown</br>
            <input  type="radio" name="target" value="rodyti"> Nerodyti kategorijų dropdown</br>
        </form>    
    </div>
</body>
</html>
