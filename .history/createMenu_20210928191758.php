            ...
            if(isset($_GET["menuType"])) {
                ...
                <?php if($menuType == 1) { ?>
                    ...
                    <form action="createMenu.php" method="get">
                        ...
                        <input class="form-control" type="radio" name="target" value="_self"> Atsidarys tame pačiame</br>
                        <input class="form-control" type="radio" name="target" value="_blank"> Atsidarys kitame lange</br>
